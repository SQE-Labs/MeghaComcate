...
public class AppPreRequisitesUtils extends AgencyCreationUtils {
    ...
    public static void AgencySetup_VerifyUploadedAgencyParcelFile() throws InterruptedException {
        ...
        WebElement SaveChangesButtonMS = (WebElement) jser.executeScript("return document.querySelector('div > div.agency-setup-tab__actions.map-settings__actions > button.square-btn.btn.btn-primary')");
        Thread.sleep(6000);
    ...
    public static void AgencySetup_VerifyCreatedUser() throws InterruptedException {
        ...
        WebDriverWaits.ClickOn(AppMenuIcon);
        Thread.sleep(6000);
        WebElement AgencySetupIconJS = (WebElement) jser.executeScript("return document.querySelector('div.tools-dropdown__tool.flex-column--center.active > a')");
        Thread.sleep(3000);
