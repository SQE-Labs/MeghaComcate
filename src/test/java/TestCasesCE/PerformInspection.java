...
public class PerformInspection extends CCP {
    ...
    public static void PerformInspection_SelectAnyNotice() throws InterruptedException {
        ...
        extentTest.setDescription(" Verify that user is able to select a notice under 'Select a notice' sub-section of the 'Select Notice & Schedule Follow Up' section. ");
    ...
    public static void PerformInspection_SelectNoNoticeRequiredCheckbox() throws InterruptedException {
        ...
        extentTest.setDescription(" Verify that user is able to select 'No Notice' toggle button, on 'Select Notice & Schedule Follow Up' popup. ");
    ...
    public static void PerformInspection_UpdateNoticeIssueDate() throws InterruptedException {
        ...
        extentTest.setDescription(" Verify that 'Notice issue date' sub-section gets updated, when user selects a date from calendar, on 'Select Notice & Schedule Follow Up' popup. ");
        Thread.sleep(2000);
    ...
    public static void PerformInspection_VerifyIssueNoticeAndCompleteInspectionButton() {
        ...
        extentTest.setDescription(" Verify that 'Issue Notice & Complete Inspection' button appears, when any non-HTML notice option is selected, under 'Select a notice' sub-section. ");
        try {
    ...
    public static void PerformInspection_VerifyContinueButtonPresenceOnHtmlSelected() {
        ...
        extentTest.setDescription(" Verify that 'Continue' button appears, when any HTML notice option is selected, under 'Select a notice' sub-section. ");
    ...
    public static void PerformInspection_VerifyViolationsUnderReviewOpenViolations() {
        ...
        extentTest.setDescription(" Verify that only valid violations appear under 'Review Open Violations and Comply by dates' sub-section, on 'Select Notice & Schedule Follow Up' section. ");
        try {
            WebDriverWaits.ClickOn(EditVerifyVio);
            Thread.sleep(3000);
            List<WebElement> validList = WebDriverWaits.WaitUntilVisibleList(ValidBtnList);
    ...
    public static void PerformInspection_UpdateComplyByDate() {
        ...
        extentTest.setDescription(" Verify that user is able to update the Comply by date for the open violations under 'Review Open Violations and Comply by dates' sub-section of the 'Select Notice & Schedule Follow Up' section. ");
        try {
            Thread.sleep(4000);
            Thread.sleep(2000);
        } catch (InterruptedException e) {
    ...
    public static void PerformInspection_UpdateFollowUpInspectionDate() throws InterruptedException {
        ...
        extentTest.setDescription(" Verify that user is able to update the Follow-up inspection date under 'Follow-up inspection date' sub-section of the 'Select Notice & Schedule Follow Up' section. ");
    ...
    public static void PerformInspection_VerifyLoggedInUserToggleButtonState() throws InterruptedException {
        ...
        extentTest.setDescription(" Verify that logged in user appears selected by default under 'Follow-up inspection assignee' sub-section of the 'Select Notice & Schedule Follow Up' section. ");
    ...
    public static void PerformInspection_ExpandSection3() {
        ...
        extentTest.setDescription(" Verify that 'Generate Notice' section expands after clicking the 'Continue' button, when any HTML notice is selected, under 'Select Notice & Schedule Follow Up' section.");
    ...
    public static void PerformInspection_EnterCertifiedMailNumber() {
        ...
        extentTest.setDescription(" Verify that user is able to enter Certified Mail Number in the 'Certified Mail Number' field, under 'Generate Notice' section. ");
    ...
    public static void PerformInspection_VerifyRecipientSubSectionPresence() {
        ...
        extentTest.setDescription(" Verify that 'Recipient' sub-section gets displayed, when case is associated with multiple contacts, under 'Generate Notice' section. ");
    ...
    public static void PerformInspection_VerifyRecipientNoLongerMandatory() throws InterruptedException {
        ...
        extentTest.setDescription(" Verify that validation message appears after user clicks on 'Generate Notice' button, when no Recipient is selected, under 'Generate Notice' section. ");
    ...
    public static void PerformInspection_SelectMultipleContact() {
        ...
        extentTest.setDescription(" Verify that user is able to select multiple contacts from 'Recipient' sub-section, under 'Generate Notice' section. ");
        try {
            Thread.sleep(3000);
    ...
    public static void PerformInspection_VerifyResponsiblePartySectionPresence() {
        ...
        extentTest.setDescription(" Verify 'Responsible Party' section gets displayed when there are more than one contact are marked as Bill to contact or none of the contact is marked as Bill to contact when case is having multiple contacts associated with a case. ");
    ...
    public static void PerformInspection_OpenConfirmationPopupOnExitButton() {
        ...
        extentTest.setDescription(" Verify that confirmation popup opens up, when user clicks on 'Exit' button, on 'Verification Inspection in Progress' page. ");
    ...
    public static void PerformInspection_OpenGenerateNoticepopup() {
        ...
        extentTest.setDescription(" Verify that 'Generate Notice' popup opens up, when user clicks on 'Generate Notice' button, on 'Generate Notice' popup. ");
        try {
            Thread.sleep(3000);
            WebDriverWaits.ClickOn(GenerateNoticeBtn);
            String NoticePopup = WebDriverWaits.GetText(GenerateNoticePopup);
    ...
    public static void PerformInspection_CloseGenerateNoticePopup() {
        ...
        extentTest.setDescription(" Verify that 'Generate Notice' popup gets closed, when user clicks on 'Cancel' button, on 'Generate Notice' popup. ");
        try {
            Thread.sleep(1000);
            WebDriverWaits.ClickOn(CancelNoticeBtn);
            Thread.sleep(2000);
    ...
    public static void PerformInspection_VerifyPrintToggleButtonState() {
        ...
        extentTest.setDescription(" Verify that 'Print' toggle button appears selected by default on the 'Generate Notice' popup. ");
    ...
    public static void PerformInspection_SelectAnyToggleButton() {
        ...
        extentTest.setDescription(" Verify that user is able to select the 'Queue To Print'/'Do Not Print' toggle button on the 'Generate Notice' popup. ");
    ...
    public static void PerformInspection_OpenConfirmationPopupForCompleteInspection() {
        ...
        extentTest.setDescription(" Verify that confirmation popup opens up, when user clicks on 'Issue Notice & complete Inspection' button, on 'Generate Notice' popup. ");
    ...
    public static void PerformInspection_CloseConfirmationPopupOnCancel() {
        ...
        extentTest.setDescription(" Verify that confirmation popup gets closed, when user clicks on 'Cancel' button, on Confirmation popup. ");
        try {
            Thread.sleep(1000);
            WebDriverWaits.ClickOn(CancelConfirmation);
            Thread.sleep(1000);
    ...
    public static void PerformInspection_VerifyTheNoticeIssued() {
        ...
        extentTest.setDescription(" Verify that a notice gets issued successfully, when user clicks on 'Yes' button, on confirmation popup. ");
        try {
            Thread.sleep(2000);
            WebDriverWaits.ClickOn(IssueNoticeCIBtn);
            Thread.sleep(2000);
    ...
    public static void FollowUpInspection_VerifyFollowUpInspectionSubSection() {
        ...
        extentTest.setDescription(" Verify that 'Follow-up Inspection' sub-section gets added under 'Abatement Activities' section, after user performs first Inspection, on CDP. ");
        try {
            Thread.sleep(4000);
    ...
    public static void FollowUpInspection_OpenEditFollowUpInspectionPopup() {
        ...
        extentTest.setDescription(" Verify that 'Edit Follow-up Inspection1' popup opens up, when user clicks on 'Edit' icon under 'Abatement Activities' section, on CDP. ");
        try {
            Thread.sleep(1000);
    ...
    public static void FollowUpInspection_VerifyEditedDetails() {
        ...
        extentTest.setDescription(" Verify that user is able to edit & update Follow-up Inspection, after clicking on 'Update' button, on 'Edit Follow-up Inspection1' popup.");
        try {
            Thread.sleep(5000);
            WebDriverWaits.ClickOn(After7daysDateLink);
    ...
    public static void FollowUpInspection_OpenFollowUpInspectionInProgressPopup() {
        ...
        extentTest.setDescription(" Verify that 'Follow-up Inspection 1 in Progress - <Case #>' popup opens up, when user clicks on 'Perform Inspection' button, on CDP.");
        try {
            Thread.sleep(15000);
            WebDriverWaits.ClickOn(PerformInsButton);
    ...
    public static void FollowUpInspection_VerifyInspectViolationsHeadersection1() {
        ...
        extentTest.setDescription(" Verify that 'Inspect Violations' header appears for section 1 of Follow-up Inspection, on CDP.");
        try {
            Thread.sleep(8000);
    ...
    public static void FollowUpInspection_VerifyFollowUpInspection2Title() {
        ...
        extentTest.setDescription(" Verify that 'Follow-up Inspection 2' title appears under 'Abatement Activities' sub-section, after Follow-up Inspection 1 is completed, on CDP.");
        try {
            Thread.sleep(2000);
            Thread.sleep(20000);
