...
////		Thread.sleep(4000);
////		WebDriverWaits.ClickOn(CEOption);
		Thread.sleep(25000);
		...
		s1.assertAll();
		// Assert.assertEquals(CCPTitleActual, "Create A Case");
	}
	...
	public static void CCP_GlobalValidationMsgForNoData() throws InterruptedException {
		...
		extentTest.setDescription(
				"Verify that appropriate validation message appears when user clicks on 'Create Case' button without entering any data in mandatory fields, on 'Create Case' page. ");
		Thread.sleep(6000);
	...
	public static void CCP_DefaultInfoMsgOnLOcationTile() {
		...
		extentTest.setDescription(
				" Verify that an information message appears by deafult, when no location is selected, on 'Create Case' page. ");
		...
		s3.assertAll();
		// Assert.assertEquals(InfoMessage, ExpInfoMsg);
	}
	...
	public static void CCP_ValidationMsgOutsideAgencyBoundary() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that appropriate validation message appears, when user clicks on the outside of Agency boundary on map, on 'Create Case' page. ");
...
//			WebDriverWaits.clearByJSE(CCP.LocationFld);
//			Thread.sleep(2000);
	...
	public void CCP_SearchAndAddAddress() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that user is able to add a location from 'Enter Address, APN or drop a Pin on the Map' combo box, on 'Create Case' page. ");
	...
	public static void CCP_OpenAddAddressManuallyPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Add Address Manually' popup opens up, after clicking on 'Add Address Manually' link, on 'Create Case' page. ");
		...
		s7.assertAll();
		// Assert.assertEquals(PopupTitleActual, PopupTitleExpected);
	}
	...
	public static void CCP_CloseAddAddressManuallyPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Add Address Manually' popup gets closed, when user clicks on 'Cross' icon or 'Cancel' button, on 'Create Case' page. ");
	...
	public static void CCP_ValidationMsgForNoAddressDetails() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that validation messages appear when user clicks on 'Add Address' button without entering data in mandatory fields, on 'Create Case' popup.  ");
		...
		s9.assertAll();
		// Assert.assertEquals(ValidationMsgActual, ValidMsgExpected);
	}
	...
	public static void CCP_AddTheAddressManually() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that the address gets added under 'Select Location' tile, after entering address details manually & clicking on 'Add Address' button, on 'Add Address Manually' popup. ");
...
//			 WebDriverWaits.WaitUntilVisible(EditLocIcon);
		...
		s10.assertAll();
		// Assert.assertEquals(ValidateStreetAdd, "Manual Street");
	...
	public static void CCP_EditAddedAddress() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that user is able to edit the location details, after clicking on the 'Edit' icon, on 'Create Case' page. ");
	...
	public static void CCP_UpdateAddressOnSaveButton() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that address gets updated, when user edits data and clicks on 'Save' button under 'Select Location' tile, on 'Create Case' page. ");
...
//		SoftAssert s12a = new SoftAssert();
//		s12a.assertEquals(DataInterface.StreetAddress, NameLabel1);
	...
	public static void CCP_AddressShouldntGetUpdatedOnCancelButton() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that address does not get updated, when user edits data and clicks on 'Cancel' button under 'Select Location' tile, on 'Create Case' page. ");
	...
	public static void CCP_OpenFlagAddressPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Flag Address' popup opens up for an unflagged address, when user clicks on 'Flagged?' toggle button, on 'Create Case' page. ");
		Thread.sleep(2000);
	...
	public static void CCP_CloseFlagAddressPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Flag Address' popup gets closed, when user clicks on 'Cross' icon or 'Cancel' button, on 'Flag Address' popup. ");
	...
	public static void CCP_VerifyFlagAddressButtonState() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Flag address' button gets enabled, when user enters data in 'Reason to Flag the address' field, on 'Flag Address' popup. ");
	...
	public static void CCP_VerifyFlaggedButtonState() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Flagged?' toggle button gets enabled, when user clicks on 'Flag Address' button after entering data in the mandatory field, on 'Create Case' popup. ");
	...
	public static void CCP_InfoMsgForNoViolation() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that an information message appears when no violation is added, on 'Create Case' page. ");
	...
	public static void CCP_ValidationMsgForNoViolation() {
		...
		extentTest.setDescription(
				" Verify that appropriate validation message appears when user clicks on 'Create Case' button without adding any violation, on 'Create Case' page. ");
	...
	public static void CCP_InfoMsgForNonExistingData() {
		...
		extentTest.setDescription(
				" Verify that an information message appears on entering non-existing data in 'Find a violation, article number or describe the issue' field, on 'Create Case' page. ");
	...
	public static void CCP_AddCustomIssueDescriptionField() {
		...
		extentTest.setDescription(
				" Verify that 'Custom Issue Description' field gets added after entering data & clicking on 'Add custom issue description' link, on 'Create Case' page. ");
	...
	public static void CCP_validationMsgForEmptyCustomIssueDescriptionField() {
		...
		extentTest.setDescription(
				" Verify that appropriate validation message appears when 'Custom Issue Description' field is blank, on 'Create Case' page. ");
	...
	public static void CCP_AddViolationWithoutEntity() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that Violation with no entity gets added under 'Add Violations' tile via search results of 'Find a violation, article number or describe the issue' combo box, on 'Create Case' page. ");
	...
	public static void CCP_OpenViolationWithEntityPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that '<Violation>' popup opens up for violations with entity, via search results of 'Find a violation, article number or describe the issue' combo box, on 'Create Case' page. ");
		WebDriverWaits.ClickOn(ViolationSearchBox);
...
//			WebDriverWaits.ClickOn(ViolationList);
	...
	public static void CCP_ValidationMsgForNoViolationData() {
		...
		extentTest.setDescription(
				" Verify that appropriate validation message appears when user clicks on 'Add' button, without entering data in the mandatory field, on violation popup. ");
	...
	public void CCP_AddViolationWithEntity() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that a violation gets added under 'Find a violation, article number or describe the issue' combo box, when user clicks on 'Add' button after entering data in mandatory fields, on 'Create Case' page. ");
...
//			WebDriverWaits.ClickOn(ViolationList);
	...
	public static void CCP_SearchAndAddViolation() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that user is able to add a violation after selecting an option from 'Find and add existing Entity' combo box, on Violation popup. ");
		...
		if(DataInterface.agencyConfig.equalsIgnoreCase(DataInterface.agencyConfigGisDirect2o)) {
			...
			Thread.sleep(5000);
			WebDriverWaits.ClickOn(entitySeachListCss);
			Thread.sleep(1000);
			WebDriverWaits.ClickOn(AddButton);
	...
	public static void CCP_VerifyAddAnotherViolationLink() {
		...
		extentTest.setDescription(
				" Verify that 'Add Another <Violation>' link appears under each added Violation type, under 'Add Violations' tile, on 'Create Case' page. ");
	...
	public static void CCP_DeleteAddedViolation() {
		...
		extentTest.setDescription(
				" Verify that previously added violation gets deleted, when user clicks on the 'Delete' icon under 'Add Violations' tile, on 'Create Case' page. ");
	...
	public static void CCP_OpenEditViolationPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Edit <Violation>' popup opens up, when user clicks on 'Edit' icon under 'Add Violations' tile, on 'Create Case' page. ");
	...
	public static void CCP_UploadPhotoForViolation() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that a photo gets uploaded, when user selects a photo after clicking on 'Upload' button, on 'Edit <Violation>' popup. ");
	...
	public static void CCP_VerifyReplaceButtonPresence() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that the 'Upload' button converts into 'Replace' button, when user uploads a photo, on 'Edit <Violation>' popup. ");
	...
	public static void CCP_DeleteAddedPhoto() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that the added photo gets deleted, when user clicks on the 'Delete' icon, on 'Edit <Violation>' popup. ");
	...
	public static void CCP_VerifyTotalViolationsCount() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that total count along with '<Violation with entity>' count of added violations appear beside 'Add Violations' tile's header, on 'Create Case' page. ");
	...
	public static void CCP_OpenViolationListingPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that respective '<Violation> Listing' popup opens up, when user clicks on '<n> <Violation>' link next to 'Add Violation' tile header, on 'Create Case' page. ");
	...
	public static void CCP_CloseViolationListingPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that '<Violation> Listing' popup gets closed, when user clicks on 'Cancel' button or 'Cross' icon, on 'Create Case' page. ");
		WebDriverWaits.ClickOn(EntityCancelBtn);
...
//------------------------------------------------------------------- Contacts Tile ---------------------------------------------------------///
	...
	public static void CCP_OpenCreateAContactPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Create a Contact' popup opens up, when user clicks on 'Add Contact' field > 'Create a new contact' link, on 'Create Case' popup. ");
	...
	public static void CCP_ValidationMsgForNodataInNameField() {
		...
		extentTest.setDescription(
				" Verify that appropriate validation message appears when 'Create Contact' button is clicked without entering data in the mandatory field, on 'Create a Contact' popup. ");
	...
	public static void CCP_CloseCreateAContactPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Create a Contact' popup gets closed , when user clicks on 'Cancel' button, on 'Create Case' popup. ");
	...
	public static void CCP_AddNewContact() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that new contact gets added under 'Add Contact' combo box, when user clicks on 'Create Contact' button after entering data in 'Name' field, on 'Create a Contact' popup. ");
...
//			}
	...
	public static void CCP_OpenEditContactPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Edit Contact' popup opens up for newly created contact, when user clicks on 'Edit' icon, on 'Create Case' page. ");
	...
	public static void CCP_DeleteAddedContact() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that previously added contact gets deleted, when user clicks on the 'Delete' icon, on 'Create Case' page. ");
	...
	public static void CCP_VerifyTotalContactCount() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that accurate count of added contacts appear beside 'Contacts' tile's header, on 'Create Case' popup. ");
...
//------------------------------------------------------------------- Attachments Tile ---------------------------------------------------------///
	...
	public static void CCP_VerifyViolationAttachmentsPresence() throws InterruptedException{
		...
		extentTest.setDescription(
				" Verify that attachments added to the 'Add Violations' tile also appear on the 'Attachments' tile, on 'Create Case' page. ");
	...
	public static void CCP_OpenAddAttachmentsPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Add Attachments' popup opens up, when user clicks on the 'Image' icon under 'Attachments' tile, on 'Create Case' page. ");
	...
	public static void CCP_VerifyAttachmentsPreview() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that attachment's preview appears, when user selects an attachment after clicking on 'Browse file' link or 'Camera' button, on 'Add Attachments' popup. ");
	...
	public static void CCP_OpenCloseAddAttachmentsPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Close Add Attachments' confirmation popup opens up, when user clicks on 'Cross' icon or 'Cancel' button after selecting an attachment, on 'Add Attachments' popup. ");
	...
	public static void CCP_CloseAddAttachmentsPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Add Attachments' popup gets closed, when user clicks on 'Yes, Close' button, on 'Close Add Attachment' confirmation popup. ");
	...
	public static void CCP_ReopenAddAttachmentsPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Add Attachments' popup reopens, when user clicks on 'No, Don't Close' button, on 'Close Add Attachment' confirmation popup. ");
	...
	public static void CCP_AddAnAttachment() {
		...
		extentTest.setDescription(
				" Verify that an attachment gets added under 'Attachments' tile, when user clicks on 'Add' button after selecting an attachment, on 'Add Attachments' popup. ");
	...
	public static void CCP_AddMultipleAttachments() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that user is able to add multiple attachments under 'Attachments' tile, on 'Create Case' popup. ");
		JavascriptExecutor jser = (JavascriptExecutor) driver;
		Thread.sleep(3000);
		WebElement AttachmentIcon = (WebElement) jser
				.executeScript("return document.querySelector('div.tile-header-container > div > h2 > button')");
...
//    			WebDriverWaits.ClickOn(CameraButton);
	...
	public static void CCP_OpenAttachmentsDetailsPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Attachments Details' popup opens up, when user clicks on the added attachment, on 'Create Case' popup. ");
	...
	public static void CCP_UpdateAttachmentDetails() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that attachment details get updated, when user clicks on 'Update' button, on 'Attachment Details' popup. ");
	...
	public static void CCP_DeleteAnAttachment() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that an attachment gets deleted, when user clicks on 'Update' button after clicking on 'Delete' icon, on 'Attachment Details' popup ");
		Thread.sleep(2000);
	...
	public static void CCP_VerifyTotalAttachmentsCount() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that accurate count of added attachments appear beside 'Attachments' tile's header, on 'Create Case' popup. ");
		Thread.sleep(2000);
		List<WebElement> AttachmentDet = driver.findElements(AttachmentDetailsTitle);
		if ((AttachmentDet.size()) > 0) {
			WebDriverWaits.ClickOn(CancelBtnAttachDet);
	...
	public static void CCP_OpenCreateCasePopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Create Case' popup opens up, when user clicks on 'Create Case' button, on 'Create Case' page. ");
	...
	public static void CCP_VerifyCreateAndScheduleInspectionButton() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Create & Perform Inspection' button converts into 'Create & Schedule Inspection' button, when user selects 'Schedule Verification Inspection' checkbox, on 'Create Case' popup.  ");
...
//		WebDriverWaits.ClickOn(CheckboxSchIns);
	...
	public static void CCP_VerifyNextInspectionSectionState() {
		...
		extentTest.setDescription(
				" Verify that 'Next Inspection' section gets enabled, when user selects 'Schedule Verification Inspection' checkbox, on 'Create Case' popup.  ");
	...
	public static void CCP_VerifyCaseCreation() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that a case gets created, when user clicks on 'Create & Schedule Inspection' button after selecting the Assignees, 'Create Case' page.  ");
		Thread.sleep(3000);
