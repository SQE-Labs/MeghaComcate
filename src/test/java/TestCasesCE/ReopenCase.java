...
//		WebDriverWaits.ClickByJsExecuter(ClosedCase);
		...
		Thread.sleep(10000);
//		WebDriverWaits.ClickOn(ClosedCaseGrid);
		Thread.sleep(8000);
	...
	public static void ReopenCase_OpenReopenCasePopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Reopen Case' popup opens up, when user clicks on 'More' button > 'Reopen Case' option, on CDP. ");
		Thread.sleep(3000);
	...
	public static void ReopenCase_NonCompliantViolationIsRequired() {
		...
		extentTest.setDescription(
				" Verify that user is not able to Reopen a case without selecting at least one violation as Non-Compliant. ");
	...
	public static void ReopenCase_CaseDoesNotReopenOnCancel() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that Closed case does not Reopen, when user clicks on 'Cancel' button, on 'Reopen Case' popup. ");
		WebDriverWaits.ClickOn(CancelButton);
		Thread.sleep(5000);
		String ClosedStatus = WebDriverWaits.GetText(CaseStatus);
		Assert.assertEquals("Closed", ClosedStatus);
	...
	public static void ReopenCase_VerifyCaseReopenedDetails() {
		...
		extentTest.setDescription(
				" Verify that Case Reopened details get added under 'Abatement Activities' tile, on CDP. ");
