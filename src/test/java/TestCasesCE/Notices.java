...
public class Notices extends UserManagement {
	...
	public static void Notices_PreRequisite() throws InterruptedException {
		...
		Thread.sleep(20000);
		//WebDriverWaits.ClickOn(AppHeaderIcon);
	...
	public static void Notices_OpenCreateNonHtmlNoticePopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Create Non-HTML Notice' popup opens up, when user clicks on 'Create Non-HTML Notice' button, on 'Notices' page. ");
		Thread.sleep(10000);
	...
	public static void Notices_CreateNonHTMLNotice() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that user is able to create a Non-HTML Notice, after entering data into all mandatory fields, on 'Notices' page. ");
		Thread.sleep(3000);
	...
	public static void Notices_OpenCreateHtmlNoticePopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Create HTML Notice' popup opens up, when user clicks on 'Create HTML Notice' button, on 'Notices' page. ");
		Thread.sleep(6000);
	...
	public static void Notices_OpenAddMergeFieldsPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Add Merge Tables' popup opens up, when user clicks on 'Merge Tables' button, on 'Create HTML Notice' popup. ");
		Thread.sleep(2000);
	...
	public static void Notices_ApplyCategoryOnMergeFields() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that user is able to apply filters from 'Category' dropdown list, on 'Add Merge Tables' popup. ");
	...
	public static void Notices_VerifyMergeFieldsOnHtmleditor() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that respective Merge Table gets added to the HTML editor, when user clicks on any Merge Tables link, on 'Add Merge Tables' popup. ");
	...
	public static void Notices_VerifyPreviewPopup() {
		...
		extentTest.setDescription(
				" Verify that user is able to Preview the data entered in the HTML editor, on 'Preview Notice' popup. ");
		String NoticeText = WebDriverWaits.GetText(NoticeContent);
	...
	public static void Notices_VerifyAutoPopulationOfNotices() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that Notices linked to Violation Types get auto-populated while Performing Inspection. ");
//		WebDriverWaits.ClickOn(CreateHtmlNoticeBtn);
//		String RandomLabel = "HTML Vio Linked " + RandomStrings.RequiredCharacters(5);
//		WebDriverWaits.SendKeys(LabelField, RandomLabel);
//		WebDriverWaits.ClickOn(MergeFieldsLink);
//		WebDriverWaits.ClickOn(FieldResults);
//		WebDriverWaits.ClickOn(DoneButton);
//		WebDriverWaits.ClickOn(LinkToVioTypesField);
//		Thread.sleep(4000);
//		WebDriverWaits.ClickOn(WaterOptionToLink);
//		WebDriverWaits.ClickOn(LinkToVioTypesField);
//		WebDriverWaits.ClickOn(CreateNoticeBtn);
//		Thread.sleep(2000);
