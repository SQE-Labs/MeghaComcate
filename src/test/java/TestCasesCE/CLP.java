...
public class CLP extends CloseCase {
    ...
    public static void CLP_VerifyCLPOpensUp() {
        ...
        extentTest.setDescription(" Verify that 'Case Listing' page opens up, when user clicks on 'Cases' tab, on Dashboard. ");
        try {
    ...
    public static void CLP_VerifyDefaultColumns() throws InterruptedException {
        ...
        if (((DefaultCol1.isDisplayed()) == true) && (DefaultCol2.isDisplayed() == true) && (DefaultCol3.isDisplayed() == true) && (DefaultCol4.isDisplayed() == true) && (DefaultCol5.isDisplayed() == true) && (DefaultCol6.isDisplayed() == true) && (DefaultCol7.isDisplayed() == true) && (DefaultCol8.isDisplayed() == true) && (DefaultCol9.isDisplayed() == true) && (DefaultCol1.isDisplayed() == true)) {
    ...
    public static void CLP_VerifyNavigationToNextPage() {
        ...
        extentTest.setDescription(" Verify that user is able to navigate to the next page, after clicking on the 'Next' arrow icon, on CLP. ");
        try {
            Thread.sleep(5000);
    ...
    public static void CLP_VerifynavigationToSpecificPage() {
        ...
        extentTest.setDescription(" Verify that user gets navigated to the specific page, when a digit is entered in the pagination field, on CLP. ");
        try {
    ...
    public static void CLP_VerifyAscendingOrderOfCases() {
        ...
        extentTest.setDescription(" Verify that user is able to sort the cases, after clicking on the 'Case Number' header, on CLP. ");
        try {
            Thread.sleep(2000);
    ...
    public static void CLP_OpenDeleteCasePopup() {
        ...
        extentTest.setDescription(" Verify that 'Delete Case' popup opens up, when user clicks on 'Delete' link text corresponding to a case, on CLP. ");
        try {
            Thread.sleep(1000);
            WebDriverWaits.ClickOn(CaseNumberHeader);
            Thread.sleep(3000);
    ...
    public static void CLP_ValidationMsgForDeleteCase() {
        ...
        extentTest.setDescription(" Verify that validation message appears, when user clicks on 'Delete Case' button without entering dat in mandatory field, on 'Delete Case' popup. ");
        try {
            Thread.sleep(4000);
    ...
    public static void CLP_VerifyDeletedcase() {
        ...
        extentTest.setDescription(" Verify that user is able to delete a case, after entering 'DELETE' text in mandatory field, on 'Delete Case' popup. ");
        try {
            Thread.sleep(3000);
            Thread.sleep(2000);
    ...
    public static void CLP_VerifyCasesForDoNotDeleteOption() {
        ...
        extentTest.setDescription(" Verify that case does not get deleted, when user clicks on 'Do Not Delete' button, on 'Delete Case' popup. ");
        try {
            Thread.sleep(1000);
            String[] CountCases = WebDriverWaits.GetText(CasesCount).split(" ");
    ...
    public static void CLP_VerifyPrimaryFilters() {
        ...
        try {
            ...
            if (((PrimaryFilter1.isDisplayed()) == false) || (PrimaryFilter2.isDisplayed() == false) || (PrimaryFilter3.isDisplayed() == false) || (PrimaryFilter4.isDisplayed() == false)) {
    ...
    public static void CLP_VerifyClearAllFiltersLinkText() {
        ...
        extentTest.setDescription(" Verify that 'Clear all filters' link text appears, when user applies any filter on the cases, on CLP. ");
        try {
    ...
    public static void CLP_VerifyClearAllFiltersLinkNotPresent() {
        ...
        extentTest.setDescription(" Verify that 'Clear all filters' link text no longer appears, when user clicks on 'Clear all filters' link text, on CLP. ");
        try {
            WebDriverWaits.ScrollIntoView(ClearAllFiltersLink);
    ...
    public static void CLP_VerifySelectionOfSecondaryFilters() {
        ...
        extentTest.setDescription(" Verify that user is able to select secondary filters, after clicking on 'Filters' slider icon, on CLP. ");
        try {
            Thread.sleep(1000);
    ...
    public static void CLP_VerifyRemovalOfSecondaryFilters() {
        ...
        extentTest.setDescription(" Verify that secondary filter gets removed, when user clicks on 'Cross' icon of filter, on CLP. ");
        try {
            Thread.sleep(1000);
    ...
    public static void CLP_VerifySearchField() {
        ...
        extentTest.setDescription(" Verify that user is able to filter & search the cases by Case #, Location or APN, after entering data in the search field on CLP. ");
        try {
            Thread.sleep(1000);
            WebDriverWaits.ClickOn(ClearAllFiltersLink);
    ...
    public static void CLP_VerifyInfoMsgForNoSearchResults() {
        ...
        extentTest.setDescription(" Verify that an information message appears, when no search results are found for the entered data, on CLP. ");
        try {
            Thread.sleep(1000);
            WebDriverWaits.ClickOn(ClearAllFiltersLink);
    ...
    public static void CLP_VerifyAdditionOfColumns() {
        ...
        extentTest.setDescription(" Verify that user is able to add respective columns, after selecting the checkboxes from 'Column Control' widget, on CLP. ");
        try {
            Thread.sleep(1000);
            WebDriverWaits.ClickOn(ColumnControlWidget);
            Thread.sleep(1000);
    ...
    public static void CLP_VerifyRestorationOfCheckedBoxes() {
        ...
        extentTest.setDescription(" Verify that recently checked boxes get restored to default, when user clicks on 'Restore Defaults' link text, on CLP. ");
        try {
            Thread.sleep(1000);
            WebDriverWaits.ClickOn(ColumnControlWidget);
    ...
    public static void CLP_VerifyAddedColumnsAfterRestoreDefaultsLink() {
        ...
        extentTest.setDescription(" Verify that added columns no longer appear on CLP, when user clicks on 'Restore Defaults' link text. ");
        try {
            WebDriverWaits.ClickOn(ColumnOutstandingBalance);
            Thread.sleep(2000);
            WebDriverWaits.ClickOn(RestoreDefaultsLink);
    ...
    public static void CLP_OpenSaveAsPopup() {
        ...
        extentTest.setDescription(" Verify that 'Save As' popup opens up, when user clicks on 'Save As' button on the top of CLP. ");
        try {
            Thread.sleep(2000);
            driver.navigate().refresh();
            Thread.sleep(15000);
    ...
    public static void CLP_VerifyValidationMessageForSaveBtn() {
        ...
        extentTest.setDescription(" Verify that validation message appears, when user clicks on 'Save' button without entering data in 'Filter Name' field, on 'Save As' popup. ");
        try {
            Thread.sleep(2000);
    ...
    public static void CLP_VerifySavedFilter() {
        ...
        extentTest.setDescription(" Verify that filter gets saved under 'Default' dropdown list, when user clicks on 'Save' button, on CLP. ");
        try {
            Thread.sleep(2000);
    ...
    public static void CLP_VerifyDeletionOfSavedFilter() {
        ...
        extentTest.setDescription(" Verify that user is able to delete the added filter under 'Default' dropdown list, on CLP. ");
        try {
            Thread.sleep(3000);
    ...
    public static void CLP_VerifyCSVFileDownloaded() {
        ...
        extentTest.setDescription(" Verify that user is able to download the CSV file, after clicking on 'Download' button > 'CSV' option, on CLP. ");
        try {
            Thread.sleep(1000);
    ...
    public static void CLP_VerifyDirectionToCDP() {
        ...
        extentTest.setDescription(" Verify that user gets directed to the respective case, after clicking on any case link, on CLP. ");
        try {
            Thread.sleep(4000);
    ...
    public static void CLP_VerifyDirectionToCLPPreview() {
        ...
        extentTest.setDescription(" Verify that user gets directed to Case List Print Preview, after clicking on 'Print' button, on CLP. ");
        try {
            Thread.sleep(2000);
    ...
    public static void CLP_VerifyMineButtonApplication() {
        ...
        extentTest.setDescription(" Verify that only logged in Agency user's cases appear, when user clicks on 'Mine' button, on CLP. ");
        try {
            Login.LoginAgency();
