...
public class Dashboard extends CLP {
    ...
    public static void TC_Dashboard_ViewAllStaffDashboard() {
        ...
        extentTest.setDescription(" Verify that Admin User is able to view the 'All Staff' Dashboard, on 'Dashboard' page. ");
    ...
    public static void TC_Dashboard_ViewMeDashboard() {
        ...
        extentTest.setDescription(" Verify that Admin User is able to view the 'User' Dashboard, on 'Dashboard' page. ");
        try {
            Thread.sleep(4000);
            WebDriverWaits.ClickOn(DashboardDropdownArrow);
            Thread.sleep(4000);
    ...
    public static void TC_Dashboard_OpenCasesAssignedToMeLink() {
        ...
        extentTest.setDescription(" Verify that Admin User gets directed to the 'Cases' page on clicking the 'Open cases assigned to me' link, when 'Me' option is selected from the 'Staff' dropdown, on 'Dashboard' page. ");
        try {
            Thread.sleep(5000);
    ...
    public static void TC_Dashboard_OpenCasesForMyAgencyLink() {
        ...
        extentTest.setDescription(" Verify that Admin User gets directed to the 'Cases' page on clicking the 'Open cases for my agency' link, when 'Me' option is selected from the 'Staff' dropdown, on 'Dashboard' page. ");
        try {
            driver.navigate().to(DataInterface.URLDashboard);
            Thread.sleep(3000);
            WebDriverWaits.ClickOn(DashboardDropdownArrow);
    ...
    public static void TC_Dashboard_OverdueInspectionsLink() {
        ...
        extentTest.setDescription(" Verify that Admin User gets directed to the 'Cases' page on clicking the 'Overdue Inspections' link, when 'Me' option is selected from the 'Staff' dropdown, on 'Dashboard' page. ");
        try {
            driver.navigate().to(DataInterface.URLDashboard);
            Thread.sleep(3000);
            WebDriverWaits.ClickOn(DashboardDropdownArrow);
    ...
    public static void TC_Dashboard_InspectionsDueTodayLink() {
        ...
        extentTest.setDescription(" Verify that Admin User gets directed to the 'Cases' page on clicking the 'Inspections Due Today' link, when 'Me' option is selected from the 'Staff' dropdown, on 'Dashboard' page. ");
        try {
            driver.navigate().to(DataInterface.URLDashboard);
            Thread.sleep(15000);
            WebDriverWaits.ClickOn(DashboardDropdownArrow);
    ...
    public static void TC_Dashboard_TotalInspectionsLink() {
        ...
        extentTest.setDescription(" Verify that Admin User gets directed to the 'Cases' page on clicking the 'Total Inspections' link, when 'Me' option is selected from the 'Staff' dropdown, on 'Dashboard' page. ");
        try {
            driver.navigate().to(DataInterface.URLDashboard);
            Thread.sleep(3000);
            WebDriverWaits.ClickOn(DashboardDropdownArrow);
    ...
    public static void TC_Dashboard_AllStaff_OpenCasesForMyAgency() {
        ...
        extentTest.setDescription(" Verify that Admin User gets directed to the 'Cases' page on clicking the 'Open cases for my agency' link, when 'All Staff' option is selected from the 'Staff' dropdown, on 'Dashboard' page. ");
        try {
            driver.navigate().to(DataInterface.URLDashboard);
            Thread.sleep(3000);
            WebDriverWaits.ClickOn(OpenCasesForMyAgency);
    ...
    public static void TC_Dashboard_TotalcasesForMyAgencyLink() {
        ...
        extentTest.setDescription(" Verify that Admin User gets directed to the 'Cases' page on clicking the 'Total cases for my agency' link, when 'All Staff' option is selected from the 'Staff' dropdown, on 'Dashboard' page. ");
        try {
            driver.navigate().to(DataInterface.URLDashboard);
            Thread.sleep(15000);
    ...
    public static void TC_Dashboard_AllStaff_OverdueInspections() {
        ...
        extentTest.setDescription(" Verify that Admin User gets directed to the 'Cases' page on clicking the 'Overdue Inspections' link, when 'All Staff' option is selected from the 'Staff' dropdown, on 'Dashboard' page. ");
        try {
            driver.navigate().to(DataInterface.URLDashboard);
            Thread.sleep(3000);
            WebDriverWaits.ClickOn(OverdueInspections);
    ...
    public static void TC_Dashboard_AllStaff_InspectionsDueToday() {
        ...
        extentTest.setDescription(" Verify that Admin User gets directed to the 'Cases' page on clicking the 'Inspections Due Today' link, when 'All Staff' option is selected from the 'Staff' dropdown, on 'Dashboard' page. ");
        try {
    ...
    public static void TC_Dashboard_AllStaff_TotalInspectionsLink() {
        ...
        extentTest.setDescription(" Verify that Admin User gets directed to the 'Cases' page on clicking the 'Total Inspections' link, when 'All Staff' option is selected from the 'Staff' dropdown, on 'Dashboard' page. ");
        try {
            driver.navigate().to(DataInterface.URLDashboard);
            Thread.sleep(15000);
    ...
    public static void TC_Dashboard_OpenTotalInspectionPopup() {
        ...
        extentTest.setDescription(" Verify that '<Count> Total Inspections' popup opens up after clicking on the 'Show More' link under '<Count> Total Inspections' section, when 'All Staff' option is selected from the 'Staff' dropdown, on 'Dashboard' page. ");
        try {
            driver.navigate().to(DataInterface.URLDashboard);
            Thread.sleep(3000);
            JavascriptExecutor js = (JavascriptExecutor) driver;
    ...
    public static void TC_Dashboard_CompareCountOfCasesWithCLP() {
        ...
        extentTest.setDescription(" Verify that accurate count of cases appear on 'Dashboard' page with respect to CLP. ");
        try {
            Thread.sleep(10000);
            driver.navigate().to(DataInterface.URLDashboard);
            Thread.sleep(10000);
    ...
    public static void TC_Dashboard_OpenPrintQueuePopup() throws InterruptedException {
        ...
        extentTest.setDescription(" Verify that 'Print Queue' popup opens up, when user clicks on '<count> notices in your print queue' link, on 'Dashboard' page. ");
