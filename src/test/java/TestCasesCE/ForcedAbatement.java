...
public class ForcedAbatement extends PerformInspection {
	...
	public static void ForcedAbatement_OpenInitiateForcedAbabtementPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Initiate Forced Abatement' popup opens up after clicking on the 'More'>'Initiate Forced Abatement' button on the CDP. ");
		//Login.LoginAgency();
		Thread.sleep(2000);
	...
	public static void ForcedAbatement_ValidationMsgForEmptyNote() {
		...
		extentTest.setDescription(
				" Verify that appropriate validation message appears when user clicks on 'Initiate Forced Abatement' button, without adding any note, on the 'Initiate Forced Abatement' popup. ");
		try {
			Thread.sleep(4000);
			...
			s116.assertAll();
			// Assert.assertEquals(ValidMsg, ExpValidMag);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	}
	...
	public static void ForcedAbatement_ValidationMsgForCharactersOver500InNote() {
		...
		extentTest.setDescription(
				" Verify that validation message appears after clicking on the 'Initiate Forced Abatement' button, when more than 500 characters are entered in the 'Note' field, on 'Initiate Forced Abatement' popup. ");
		try {
			...
			s117.assertAll();
			// Assert.assertEquals(LimitError, "500 character limit.");
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	}
	...
	public static void ForcedAbatement_InitiateForcedAbatement() {
		...
		extentTest.setDescription(
				" Verify that User is able to initiate the Forced Abatement on the 'Initiate Forced Abatement' popup. ");
		try {
	...
	public static void ForcedAbatement_VerifyForcedStageBadge() {
		...
		extentTest.setDescription(
				" Verify that Abatement stage badge converts into Forced, when FA has been initiated. ");
		try {
			Thread.sleep(1000);
	...
	public static void ForcedAbatement_OpenEditFaNotePopup() {
		...
		extentTest.setDescription(
				" Verify that 'Edit FA Note' popup opens up, when user clicks on 'Edit' link, under 'Abatement Activities' tile. ");
		try {
			Thread.sleep(6000);
			...
			s119.assertAll();
			// Assert.assertEquals(EditFAPopup, "Edit FA Note");
		} catch (InterruptedException e) {
			e.printStackTrace();
	...
	public static void ForcedAbatement_EditNoteInEditFaNoteField() {
		...
		extentTest.setDescription(
				" Verify that user is able to edit note in the 'Edit FA Note' field, on 'Edit FA Note' popup. ");
		try {
			Thread.sleep(4000);
			...
			s120.assertAll();
			// Assert.assertEquals(EditedFANote, "Notes for FA Edited*");
		} catch (InterruptedException e) {
			e.printStackTrace();
	...
	public static void ForcedAbatement_VerifyTheUpdatedNote() {
		...
		extentTest.setDescription(
				" Verify that the edited note gets updated, when user clicks on save button, on 'Edit FA Note' popup ");
		try {
			Thread.sleep(4000);
	...
	public static void ForcedAbatement_VerifyAddActivityBtn() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Add Activity' button appears under the 'Abatement Activities' tile, when user has created Forced Abatement Activity on the 'Case Management'>'Forced Abatement' page. ");
		...
		s122.assertAll();
		// Assert.assertEquals(ActivityBtn, "Add Activity");
	...
	public static void ForcedAbatement_OpenAddForcedAbatementActivityPopup() {
		...
		extentTest.setDescription(
				" Verify that 'Add Forced Abatement Activity' popup opens up, when user clicks on 'Add Activity' button, under 'Abatement Activities' tile. ");
		try {
			Thread.sleep(2000);
			...
			s123.assertAll();
			// Assert.assertEquals(AddFAActivity, "Add Forced Abatement Activity");
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	}
	...
	public static void ForcedAbatement_VerifyFirstActivityBtnState() {
		...
		extentTest.setDescription(
				" Verify that first abatement activity type appears selected by default, under 'Choose Activity Type' field, on 'Add Forced Abatement Activity' popup. ");
	...
	public static void ForcedAbatement_ValidationMsgForNoDataOfActivity() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that validation messages appear, when user clicks on 'Add Forced Abatement Activity' button without entering data in mandatory fields, on 'Add Forced Abatement Activity' popup. ");
		Thread.sleep(2000);
	...
	public static void ForcedAbatement_VerifyDocumentNoteFieldPresence() {
		...
		extentTest.setDescription(
				" Verify that 'Document Note' mandatory field gets added under 'Select Document' dropdown box, when user selects any document, on 'Add Forced Abatement Activity' popup. ");
		try {
			Thread.sleep(2000);
	...
	public static void ForcedAbatement_ValidationMsgForEmptyDocumentNote() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that validation message appears, when user clicks on 'Add Forced Abatement Activity' button without entering data in 'Documnet Note' field, on 'Add Forced Abatement Activity' popup. ");
		Thread.sleep(1000);
	...
	public static void ForcedAbatement_AddForcedAbatementActivity() {
		...
		extentTest.setDescription(
				" Verify that User is able to Add Forced Abatement Activity after entering data in all mandatory fields & clicking on 'Add Forced Abatement Activity' button, on 'Add Forced Abatement Activity' popup.");
		try {
			...
			//WebDriverWaits.ClickOn(GenerateDocBtn);
	...
	public static void ForcedAbatement_OpenEditForcedAbatementActivityPopup() {
		...
		extentTest.setDescription(
				"Verify that 'Edit Forced Abatement Activity' popup opens up, when user clicks on Edit icon, next to Forced Abatement Activity. ");
		try {
			Thread.sleep(25000);
			WebDriverWaits.ScrollIntoView(EditActivityIcon);
			Thread.sleep(3000);
			WebDriverWaits.ClickOn(EditActivityIcon);
//			String[] EditFAPopupTitle1 = WebDriverWaits.GetText(EditActivityPopup).split(" ");
//			String EditFA1 = EditFAPopupTitle1[0];

			//String[] EditFAPopupTitle2 = WebDriverWaits.GetText(EditFAAPopup).split("-");
//			String EditFA2 = EditFAPopupTitle2[1];
//			String ActualEditFATitle = EditFA1 + EditFA2;
			...
			s129.assertAll();
			// Assert.assertEquals(ActualEditFATitle, ExpectedEditFATitle);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	}
	...
	public static void ForcedAbatement_CloseEditForcedAbatementActivityPopup() {
		...
		extentTest.setDescription(
				" Verify that 'Edit Forced Abatement Activity' popup gets closed without updating changes, when user clicks on 'Cancel' button or 'Cross' icon, on CDP. ");
		try {
	...
	public static void ForcedAbatement_EditAddedActivity() {
		...
		extentTest.setDescription(
				" Verify that user is able to edit and save the previously added Forced Abatement Activity, on 'Case Detail' page. ");
		try {
			Thread.sleep(6000);
			//WebDriverWaits.ClickOn(EditActivityIcon);
			...
			s131.assertAll();
			// Assert.assertEquals(EditedLabelText, "Edited C123C456");
		} catch (InterruptedException e) {
			e.printStackTrace();
	...
	public static void ForcedAbatement_ConfirmationPopupForDeletingActivity() {
		...
		extentTest.setDescription(
				" Verify that confirmation popup opens up, when user clicks on 'Cross' icon, next to Forced Abatement Activity. ");
		try {
			Thread.sleep(1000);
	...
	public static void ForcedAbatement_DeleteAddedActivity() {
		...
		extentTest.setDescription(
				" Verify that the Forced Abatement Activity gets deleted, when user clicks on 'Yes, Delete' button, on confirmation popup. ");
		try {
	...
	public static void ForcedAbatement_VerifyAbleToSelectActivityType() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that user is able select activity types under 'Choose Activity Type' toggle, on 'Add Forced Abatement Activity' pop up");
	...
	public static void ForceAbatement_AbatementDetailsPopupopen() throws InterruptedException {
		extentTest = extent.startTest(" ForcedAbatement_VerifyAbleToSelectActivityType ");
		extentTest.setDescription(
				"Verify that 'Abatement Details'  pop up open when click on 'Continue to Generate Document'");
	...
	public static void ForceAbatement_AbatementDetailsDetails () throws InterruptedException{
		...
		extentTest.setDescription(
				"Verify that 'Abatement Details'  section deatils auto Populated");
		Thread.sleep(4000);
	...
	public static void ForceAbatement_AttachmentSectionAppearFAADocSelected () throws InterruptedException{
		...
		extentTest = extent.startTest(" ForceAbatement_AbatementDetailsDetails ");
		extentTest.setDescription(
				"Verify that 'Attachements' section appears, when the 'FAA Document'selected has attachements merged code and user has uploaded images on the case");
//	    Login.LoginAgency();
		Thread.sleep(2000);
		...
		driver.findElements(photosAttached)
				.stream()
				.forEach(img -> Images.add(img.getText()));
	...
	public static void ForceAbatement_ContactAppearUnderResponsibleParty() throws InterruptedException {
		extentTest = extent.startTest(" ForceAbatement_AbatementDetailsDetails ");
		extentTest.setDescription(
				"Verify contact details appear under resposible party section when 'zero' or 'more than one contact' are choosen bill to contact");

		// ForceAbatement_AttachmentSectionAppearFAADocSelected();
		Thread.sleep(10000);
	...
	public static void ForceAbatement_SelectedAttachmentPopulatedonPrintPreview () throws InterruptedException {
		...
		extentTest = extent.startTest(" ForceAbatement_AbatementDetailsDetails ");
		extentTest.setDescription(
				"Verify that selected attachement appears on 'Generate FAA Document' print preview pop up" );

//		ForceAbatement_AttachmentSectionAppearFAADocSelected();
//		ForceAbatement_ContactAppearUnderResponsibleParty();
//		
