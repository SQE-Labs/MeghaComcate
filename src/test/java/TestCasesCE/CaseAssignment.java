...
public class CaseAssignment extends Dashboard {
	...
	public static void CaseAssignment_OpenEditAssignmentPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that 'Edit Assignment' popup opens up after clicking the 'Edit' icon next to 'Case Assignment' rule on the 'Assignment Rules' page. ");
	...
	public static void CaseAssignment_EditFieldsOnEditAssignmentPopup() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that user is able to update the 'Name', 'Action' & 'Status' fields on the 'Edit Assignment' popup ");
...
//		}
	...
	public static void CaseAssignment_CreateRuleWithMultipleCriterias() throws InterruptedException {
		...
		extentTest.setDescription(
				" Verify that the created rule with one or multiple criterias, gets added under 'Rules Set' tile, on 'Edit Assignment' popup. ");
		try{	WebDriverWaits.ClickOn(CriteriaFields);
			Thread.sleep(2000);
	...
	public static void CaseAssignment_EditAddedRule() throws InterruptedException {
		...
		try{String AssigneeBefore = WebDriverWaits.GetText(AssignCaseToColumn);
			...
			Assert.assertEquals(CompareStr, false);}catch(Exception e){
