...
public class TemplateManagement extends TemplateMangementUtils {
    ...
    public static void TemplateMangement_PreRequisite() throws InterruptedException {
        ...
        extentTest.setDescription("Verify TemplateMangement sub tab is open after clicking on TemplateMangement sidebar under Agency setup.");
    ...
    public static void TemplateMangement_CloseandOpenCreateTemplatePOpup() throws InterruptedException {
        ...
        extentTest.setDescription("Verify that user is able to open and close the '' popup after clicking the '' and '' buttons on '' and '' pages respectively");
    ...
    public static void TemplateMangement_VerifyValidationsOnCreateTemplatePOpup() throws InterruptedException, AWTException {
        extentTest = extent.startTest(" TemplateMangement_CloseandOpenCreateTemplatePOpup ");
        extentTest.setDescription("Verify that appropriate validation messages appears, on clicking the 'Save' button when no/ data exceeding the max limit is entered in fields, on 'Create Template' popup");
    ...
    public static void TemplateMangement_VerifyAdditionofMultipleDocTemplatePOpup() throws InterruptedException, AWTException {
        extentTest = extent.startTest(" TemplateMangement_CloseandOpenCreateTemplatePOpup ");
        extentTest.setDescription("Verify that user is able to add/remove a single as well as multiple documents, on 'Create Template' popup");
