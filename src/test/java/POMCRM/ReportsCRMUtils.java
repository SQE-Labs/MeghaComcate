...
public class ReportsCRMUtils extends DashboardCRMUtils {
    ...
    public static By QSReportsList = By.xpath("//div[@class='product-form__executive-reports']//div[@class='rt-td'][1]");
    public static By QSReportEditIcon = By.xpath("//div[@class='product-form__executive-reports']//button");
    public static By DashboardIDList = By.xpath("//div[@class='product-form__executive-reports']//div[@class='rt-td'][2]");
